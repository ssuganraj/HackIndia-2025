        ...
        <>
            ...
            <div className="w-screen fixed top-0 flex justify-evenly items-center z-[20] bg-gray-300" >
                <motion.div className=" text-primary px-2 py-2 lg:px-4 lg:py-2  rounded-xl ml-2" variants={itemVariants} whileInView="visible" initial="hidden">
                    <p className="hover:text-[1.2rem] transition-all duration-300 cursor-pointer text-[1rem] lg:text-[1.2rem] font-[800] "
                           onClick={() => navigate("/")}>Pasumai Cholai
                    </p>
                </motion.div>

                    <motion.div className="flex justify-evenly items-center   px-4 py-2 bg-opacity-60  rounded-xl w-[40%] z-[99]" variants={itemVariants} whileInView="visible" initial="hidden">
                       ...
                       <p
                        className="hover:tracking-widest hover:scale-[1.1] transition-all duration-300 cursor-pointer text-[1.2rem] font-[550] hover:text-secondary"
                                       ...
                                       <p
                        className="hover:tracking-widest hover:scale-[1.1] transition-all duration-300 cursor-pointer text-[1.2rem] font-[550] hover:text-secondary"
                                       onClick={() => navigate("/aiChatBot")}>AI ChatBot</p>
                                        <p
                        className="hover:tracking-widest hover:scale-[1.1] transition-all duration-300 cursor-pointer text-[1.2rem] font-[550] hover:text-secondary"
                                       onClick={() => navigate("/")}>AI Deasease</p>
